...
public:
    ...
    {
        Matriz resultado(num_lin, B.num_col);
...
int  main()
{
    try
    {
        ...
        if (c1 != l2)
        {
            cout << "Para efetuar a multiplicação, o número de colunas da M1 deve ser igual ao número de linhas da M2!";
            return 1;
        }
    ...
    cout << "Insira os elementos da Matriz 1:\n";
        ...
        Matriz M_resultado = M1.multiplicar(M2);
